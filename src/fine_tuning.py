...
pretrained_model = tf.keras.models.load_model(os.path.join(models_folder, 'mfcc_model_4l_60e_04d.h5'))
...
plot_history(history, os.path.join(models_folder, 'train_history_mfcc_model_4l_60e_retrained_2'))
...
model.save(os.path.join(models_folder, 'mfcc_model_4l_60e_04d_retrained_2.h5'))

with open('training_history_mfcc_model_4l_60e_04d_retrained_2.json', 'w') as json_file:
