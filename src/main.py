...
from cnn_basic_model import build_model, build_model_4l
...
model, X_train, X_validation, X_test, y_train, y_validation, y_test = create_basic_mfcc_model_with_dataset()
